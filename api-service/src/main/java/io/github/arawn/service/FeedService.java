...
public class FeedService {
    ...
    public FeedNotify getRemoteFeedNotify() {
        if (chaosMonkey.doItNow()) {
            throw new ServiceOperationException();
        }

        try {
            return restTemplate.getForObject("http://localhost:9000/official-announcement/feed", FeedNotify.class);
        } catch (Exception e) {
            throw new ServiceOperationException();
        }
    }
