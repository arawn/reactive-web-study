...
@RestController
@RequestMapping("/official-announcement")
public class OfficialAnnouncementRestController {

    @GetMapping("/feed")
    public Callable<OfficialAnnouncement> officialAnnouncement() {
        return () -> {
            try {
    ...
    public class OfficialAnnouncement {
        ...
        String content = words[(int) (Math.random() * 99 + 0)];
