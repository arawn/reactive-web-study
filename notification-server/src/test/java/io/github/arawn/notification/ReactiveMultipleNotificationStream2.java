...
public class ReactiveMultipleNotificationStream2 {
    ...
    final Log log = LogFactory.getLog(ReactiveMultipleNotificationStream2.class);
    ...
    public Flux<Notification> watch() {
        ...
        Flux<Notification> friendRequestNotifies = Flux.fromStream(Stream.generate(() -> friendService.getRecommendationNotify("")))
                                                       .map(Notification::of);
